...
export default function CostumChart({className , data  , statics }: {className?: string  ,  data: any[] , statics: Array<Statistcs>}) {
  ...
  return (
     <div className={`w-[95%] mt-4 p-3 mx-auto bg-white rounded-lg border-2 border-gray-200 items-center ${className}`} style={{ height: 'auto', minHeight: '70vh' }}>
          <h1 className='font-bold text-lg text-gray-700 ml-3 mb-4'>Leskaarten</h1>
          ...
          <div className='mt-6'>
            <ul  style={{gap:15}} className='flex justify-start h-max mt-4 w-[auto] mx-auto  text-gray-600 flex-wrap'>
           {
            statics.map((stat , index) => (
                < StatisticsCard 
                  ...
                  key={index}       
                    ...
                    className='h-[100%] w-[20%] py-2 px-2'
                    Icon={stat.Icon}
                />
