                ...
                <div style={{ display: 'flex', width: '100%', maxWidth: '100vw' }}>
                    ...
                    <div id='instructors-table-container' className='flex-1 overflow-x-auto hide-native-scroll'>
                        ...
                        <div className='flex w-max pl-2 bg-transparent border-b-1 border-gray-200' style={{ height: '56px' }}>
                            <div className='w-[8vw] py-4 flex items-center text-sm whitespace-nowrap truncate'>Instructeur</div>
                            <div className='w-[8vw] py-4 flex items-center text-sm whitespace-nowrap truncate'>BSN Nummer</div>
                            <div className='w-[15vw]  flex items-center py-4 text-sm whitespace-nowrap truncate'>Email</div>
                            <div className='w-[8vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>Geboortedatum</div>
                            <div className='w-[8vw]  py-4 flex items-center justify-center text-sm whitespace-nowrap truncate'>Adres</div>
                            <div className='w-[9vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>Telefoonnummer</div>
                            <div className='w-[8vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>Rijbewijs</div>
                            <div className='w-[10vw] py-4 flex items-center text-sm whitespace-nowrap truncate'>Vervaldatum Rijbewijs</div>
                            <div className='w-[10vw] py-4 flex items-center text-sm whitespace-nowrap truncate'>Instructeurskaart</div>
                            <div className='w-[10vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>KVK Uittreksel</div>
                            <div className='w-[10vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>Arbeidsovereenkomst</div>
                            <div className='w-[11vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>Contractvervaldatum</div>
                            <div className='w-[7vw]  py-4 flex items-center text-sm whitespace-nowrap truncate'>Urenregistratie</div>
                        </div>
                        {/* Scrollable Body */}
                        <div className='w-max'>
...
const InstructorElementScrollable = ({ ele }: { ele: Data_Instructor }) => {
    ...
    <div className='flex relative pl-2 w-max border-b-1 bg-white hover:bg-blue-100/10 border-gray-200' style={{ height: '52px' }}>
            <div className='w-[8vw]  flex items-center text-sm text-gray-700'>{ele.instructor}</div>
            <div className='w-[8vw]  flex items-center text-sm text-gray-700'>{ele.bsn_nummer}</div>
            <div className='w-[15vw]  flex items-center text-sm text-gray-700'>
                <Link href={`mailto:${ele.email}`}>
                {ele.email}
                </Link>
            </div>
            <div className='w-[8vw]  flex items-center text-sm text-gray-700'>{ele.Date_birth}</div>
            ...
            <Link
                ...
                className='w-[9vw] flex items-center text-sm text-gray-700 truncate transition-colors hover:text-blue-800 cursor-pointer'
                title={ele.phone_number}
            >
                {ele.phone_number}
            </Link>
            <div className='w-[8vw] flex items-center text-sm text-gray-700'>
                <button
                    type='button'
            ...
            <div className='w-[10vw]  flex items-center text-sm text-gray-700'>{ele.license_expiration_date}</div>
            <div className='w-[10vw]  flex items-center text-sm text-gray-700'>
                <button
                    type='button'
            ...
            <div className='w-[10vw] min-w-[180px]  flex items-center text-sm text-gray-700'>
                <button
                    type='button'
            ...
            <div className='w-[11vw]  flex items-center text-sm text-gray-700'>{ele.contract_expiration_date}</div>
            <div className='w-[7vw]  flex items-center text-sm text-gray-700'>{ele.hours_registration}</div>
        </div>
    )
}
    ...
    return (
        ...
        >
            <div className='   w-[80px] px-3 flex justify-center items-center h-full border-l-1 border-gray-200'>
                ...
                <ActionModal id={ele.id?.toString() } className='right-[-.3vw]'  tableName='instructors' ref={modalRef} />
            </div>
        </div>
    )
}
