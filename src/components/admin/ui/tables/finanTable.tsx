          ...
          <div id='rijlessen-table-container' className='flex-1 overflow-x-auto hide-native-scroll'>
            ...
            <div className='flex w-max bg-transparent border-b-1 border-gray-200 items-center' style={{ height: '56px' }}>
              <div className='w-[7vw] min-w-[120px] py-4 flex items-center justify-center text-md px-2 whitespace-nowrap truncate'>Student</div>
                            <div className='w-[9vw] min-w-[140px] py-4 flex items-center justify-center text-md px-2 whitespace-nowrap truncate'>Datum rijles</div>
              ...
              <div className='w-[9vw] min-w-[140px] py-4 flex items-center justify-center text-md px-2 whitespace-nowrap truncate'>Vervaldatum</div>
...
const FinanceElementScrollable = ({ ele, currentTap = "pending" }: { ele: ParsedLesson , currentTap?: string }) => {
  ...
  <div className='w-[7vw] min-w-[120px] flex items-center justify-center  text-sm text-gray-700 px-2 truncate overflow-hidden' title={ele?.student!}>{ele?.student}</div>
    <div className='w-[9vw] min-w-[140px] flex items-center justify-center whitespace-nowrap scale-95  text-sm text-gray-700 px-2' title={ele?.date+"."+ele?.start_time}>{ele?.date}</div>
        <div className='w-[9vw] min-w-[140px] flex items-center justify-center whitespace-nowrap scale-95  text-sm text-gray-700 px-2' title={ele?.start_time}>{ele?.start_time.substring(0,5)}</div>
  <div className='w-[9vw] min-w-[140px] flex items-center justify-center whitespace-nowrap scale-95  text-sm text-gray-700 px-2' title={ele?.end_time}>{ele?.end_time.substring(0,5)}</div>
  <div className='w-[6vw] min-w-[90px] flex items-center justify-center  text-sm text-gray-700 px-2 truncate overflow-hidden' title={ele?.lesson_duration}>{ele?.lesson_duration}</div>
      <div className='w-[9vw] min-w-[140px] flex items-center justify-center whitespace-nowrap scale-95  text-sm text-gray-700 px-2' title={ele?.end_time}>_</div>
