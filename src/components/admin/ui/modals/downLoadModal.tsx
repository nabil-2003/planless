...
const Download= forwardRef<ModalRef , props>(({id, table}, ref)=>{
    ...
    return (
        <div  id={'action_confirm'} className='fixed  hidden  place-items-center  select-none   inset-0  '  ref={refDiv}>
                 ...
                 <img src="/download_icon.svg" alt="" className='w-[80vw] md:w-[15vw] h-[10vh] mx-auto mt-4' />
...
Download.displayName ="DownloadModal"
